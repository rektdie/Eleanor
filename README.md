...
**Architecture:** `(768x8hm -> 1536)x2 -> 1x8`  
A 1536-hidden-layer *perspective net* with 8 input buckets, 8 output buckets and horizontal mirroring.
