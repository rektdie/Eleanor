...
static SearchResults Quiescence(Board board, int alpha, int beta, int ply) {
    ...
    int bestScore = UTILS::ConvertToWhiteRelative(board, NNUE::net.Evaluate(board));
...
SearchResults PVS(Board board, int depth, int alpha, int beta, int ply) {
    ...
    const int staticEval = UTILS::ConvertToWhiteRelative(board, NNUE::net.Evaluate(board));
